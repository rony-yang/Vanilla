		...
		<div class="container">
			<div style="width: 100%; height: auto;">
				<div style="width: 40%; height: auto; float: left;">
					<a href="#" class="image featured"><img src="./resources/images/bottom/<%=product.getProductCode()%>.jpg" alt=""/></a>
				</div>
			...
			<div style="text-align: center;">
				...
				<a href="productBottom.jsp" class="button small icon solid fa-arrow-circle-right" style="margin: 20px auto; padding: 0px 20px; font-size: 17px; justify-content: center;">목록으로 돌아가기</a>
			</div>
